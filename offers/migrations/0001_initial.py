    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_city_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offers.City')),
                ('fk_country_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offers.Country')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='location',
            name='fk_state_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offers.State'),
        ),
        migrations.AddField(
            model_name='city',
            name='fk_country_id',
