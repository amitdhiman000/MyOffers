...
/******/ 	return __webpack_require__(__webpack_require__.s = "../desktop/ts/AppMain.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./History */ "../desktop/ts/History.ts"), __webpack_require__(/*! ./AppUtils */ "../desktop/ts/AppUtils.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, History_1, AppUtils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var App = /** @class */ (function () {
        ...
        App.prototype.name = function () {
            AppUtils_1.AppUtil.Instance().name();
        };
        App._instance = null;
        return App;
    }());
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./App */ "../desktop/ts/App.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, App_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ../../libs/jquery/jquery-3.3.1.min */ "../libs/jquery/jquery-3.3.1.min.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, jquery_3_3_1_min_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var AppUtil = /** @class */ (function () {
        ...
        AppUtil.prototype.csrfToken = function () {
            var $mt = jquery_3_3_1_min_1.$('meta[name=csrf-token]');
            var data = {};
        ...
        AppUtil.prototype.name = function () {
            if (!this._name) {
                var $mt = jquery_3_3_1_min_1.$('meta[name=app-name]');
    ...
    var Cookie = /** @class */ (function () {
        ...
        Cookie.prototype.has = function (cname) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ../../libs/jquery/jquery-3.3.1.min */ "../libs/jquery/jquery-3.3.1.min.js"), __webpack_require__(/*! ./HttpService */ "../desktop/ts/HttpService.ts"), __webpack_require__(/*! ./App */ "../desktop/ts/App.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, jquery_3_3_1_min_1, HttpService_1, App_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        History.prototype.init = function () {
            ...
            if (window.history && window.history.pushState) {
                var afterGetResponse_1 = function (status, data, state) {
                    ...
                    if (status) {
                        jquery_3_3_1_min_1.$(state.dest[0]).html(data);
                        history.pushState(state, state.title, state.url);
                        document.title = state.title;
                    }
                    else {
                        jquery_3_3_1_min_1.$(state.dest[0]).html("<h1>Failed to load page</h1>");
                ...
                jquery_3_3_1_min_1.$(document).on('click', 'a[data-dest]', function (e) {
                    e.preventDefault();
                    console.log("+a");
                    var This = jquery_3_3_1_min_1.$(this);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ../../libs/jquery/jquery-3.3.1.min */ "../libs/jquery/jquery-3.3.1.min.js"), __webpack_require__(/*! ./UIToast */ "../desktop/ts/UIToast.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, jquery_3_3_1_min_1, UIToast_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var HttpService = /** @class */ (function () {
        ...
        HttpService.prototype.request = function (handler, options) {
            console.log("+request");
            return this._request(handler, options);
        };
        HttpService.prototype._request = function (handler, options) {
            if (handler === void 0) { handler = HttpResponseHandler; }
            if (options === void 0) { options = {}; }
            var methods = {
                dataType: 'text',
                xhr: function () {
                    var xhr = jquery_3_3_1_min_1.$.ajaxSettings.xhr();
            ...
            jquery_3_3_1_min_1.$.extend(options, methods);
            this._handle = jquery_3_3_1_min_1.$.ajax(options);
        };
        return HttpService;
    }());
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ../../libs/jquery/jquery-3.3.1.min */ "../libs/jquery/jquery-3.3.1.min.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, jquery_3_3_1_min_1) {
    ...
    var UIToast = /** @class */ (function () {
        ...
        UIToast.prototype.show = function (text, timeout) {
            ...
            jquery_3_3_1_min_1.$('.wt-toast').fadeIn({
                duration: 500,
                start: function () { jquery_3_3_1_min_1.$(this).text(text); },
            }).delay(timeout).fadeOut(500);
        };
        UIToast.prototype.hide = function () {
            jquery_3_3_1_min_1.$('.wt-toast').hide();
        };
